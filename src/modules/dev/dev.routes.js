...
// Rotas de desenvolvimento nunca podem existir em produção.
// Mesmo que algum app.use("/api/dev", ...) seja adicionado no futuro,
// o router vazio garante 404 em produção.
